...
public class PostRepository extends BaseRepository<Post> {
    ...
    private static final String INSERT_QUERY = "INSERT INTO posts(authorId, description, post_date)" +
            "VALUES (?, ?, ?) returning id";
    private static final String UPDATE_QUERY = "UPDATE posts SET authorId = ?, description = ? WHERE id = ?";
